...
def flood_fill(pos_x, pos_y, last_cell):
    global value_matrix, state_matrix
    if state_matrix[pos_x][pos_y] != "H" or (value_matrix[pos_x][pos_y] != 0 and last_cell != 0):
        return None
    else:
        state_matrix[pos_x][pos_y] = "S"

    last_cell = value_matrix[pos_x][pos_y]
...
while game_state != "quit":
    ...
    if game_state == "new_game":
        value_matrix = create_matrix(8, 8, 8)
    ...
    if game_state == "solve":
        ...
        while game_state == "solve":
            ...
            if first_click or result_3:
                if state_matrix[choice_x][choice_y] == "H":
                    if value_matrix[choice_x][choice_y] == 0:
                        flood_fill(choice_x, choice_y, 0)
                    elif isinstance(value_matrix[choice_x][choice_y], int):
                        state_matrix[choice_x][choice_y] = "S"
                    elif value_matrix[choice_x][choice_y] == "B":
                        value_matrix[choice_x][choice_y] = "X"
                        game_state = "lose"
